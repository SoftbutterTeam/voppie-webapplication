...
export function CenteredLayout(props: Props) {
  ...
  return (
    <div className="grid grid-cols-1 min-w-[300px] sm:grid-cols-10 h-screen w-full ">
      <div className=" w-64 md:w-96 h-96 md:h-full bg-orange-600 bg-opacity-60 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform"></div>
